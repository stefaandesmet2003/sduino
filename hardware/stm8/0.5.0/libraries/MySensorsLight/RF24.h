...
// STM8 : SS = PA3, ofwel nemen we PC3 voor CS, mooi 5 pinnen op een rij
#define DEFAULT_RF24_CE_PIN				(PC4)		//!< DEFAULT_RF24_CE_PIN
#define DEFAULT_RF24_CS_PIN				(SS)	//!< DEFAULT_RF24_CS_PIN

// andere defines uit MySensors.h / MyConfig.h
...
// TODO : aangezien RF24.c nu een afzonderlijk object is, niet zoals bij MySensors
